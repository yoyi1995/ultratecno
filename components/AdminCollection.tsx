...
const fields: Record<Collection, Field[]> = {
  ...
  services: [{ key: 'title', label: 'Título', required: true }, { key: 'category', label: 'Tipo de servicio', type: 'select', required: true, options: [['mantenimiento', 'Mantenimiento preventivo'], ['reparacion', 'Reparación / diagnóstico']] }, { key: 'description', label: 'Descripción', type: 'textarea', required: true }, { key: 'includes', label: 'Qué incluye / síntomas frecuentes', type: 'list', hint: 'Mantenimiento: tareas incluidas. Reparación: síntomas que presenta el equipo.' }, { key: 'problems', label: 'Prevención / fallas frecuentes', type: 'list', hint: 'Mantenimiento: problemas que ayuda a prevenir. Reparación: fallas frecuentes.' }, { key: 'recommendations', label: 'Recomendaciones / áreas a revisar', type: 'list', hint: 'Mantenimiento: recomendaciones. Reparación: posibles áreas que requieren diagnóstico.' }],
